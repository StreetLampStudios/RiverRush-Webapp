...
!function () {
    ...
    d.prototype = {
        init: function () {
            ...
            if (e = parseFloat(e), "undefined" != typeof e && e >= 0 && 1 >= e) {
                ...
                for (var t = 0; t < n._howls.length; t++)if (!n._howls[t]._webAudio)for (var d = n._howls[t]._getSoundIds(), i = 0; i < d.length; i++) {
                    var a = n._howls[t]._soundById(d[i]);
    ...
    var u = new d, i = function (e) {
        var n = this;
        return e.src ? void n.init(e) : void console.error("An array of source files must be passed with any new Howl.")
    };
    i.prototype = {
        init: function (e) {
            var t = this;
            ...
            return n ? (e._src = n, new a(e), e._webAudio && s(e), e) : void e._emit("loaderror")
        }, play: function (e) {
            var o = this, t = null;
            if ("number" == typeof e)t = e, e = null; else if ("undefined" == typeof e) {
                e = "__default";
                for (var r = 0, d = 0; d < o._sounds.length; d++)o._sounds[d]._paused && !o._sounds[d]._ended && (r++, t = o._sounds[d]._id);
                1 === r ? e = null : t = null
            }
            var i = t ? o._soundById(t) : o._inactiveSound();
            if (!i)return null;
            if (t && !e && (e = i._sprite || "__default"), !o._loaded && !o._sprite[e])return o.once("load", function () {
                o.play(o._soundById(i._id) ? i._id : void 0)
            }), i._id;
            if (t && !i._paused)return i._id;
            var a = i._seek > 0 ? i._seek : o._sprite[e][0] / 1e3, _ = (o._sprite[e][0] + o._sprite[e][1]) / 1e3 - a, s = function () {
                var t = !(!i._loop && !o._sprite[e][2]);
                o._emit("end", i._id), !o._webAudio && t && o.stop(i._id).play(i._id), o._webAudio && t && (o._emit("play", i._id), i._seek = i._start || 0, i._playStart = n.currentTime, o._endTimers[i._id] = setTimeout(s, 1e3 * (i._stop - i._start) / Math.abs(o._rate))), o._webAudio && !t && (i._paused = !0, i._ended = !0, i._seek = i._start || 0, o._clearTimer(i._id), i._node.bufferSource = null), o._webAudio || t || o.stop(i._id)
            };
            o._endTimers[i._id] = setTimeout(s, 1e3 * _ / Math.abs(o._rate)), i._paused = !1, i._ended = !1, i._sprite = e, i._seek = a, i._start = o._sprite[e][0] / 1e3, i._stop = (o._sprite[e][0] + o._sprite[e][1]) / 1e3, i._loop = !(!i._loop && !o._sprite[e][2]);
            var l = i._node;
            if (o._webAudio) {
                var f = function () {
                    o._refreshBuffer(i);
                    var e = i._muted || o._muted ? 0 : i._volume * u.volume();
                    l.gain.setValueAtTime(e, n.currentTime), i._playStart = n.currentTime, "undefined" == typeof l.bufferSource.start ? l.bufferSource.noteGrainOn(0, a, _) : l.bufferSource.start(0, a, _), o._endTimers[i._id] || (o._endTimers[i._id] = setTimeout(s, 1e3 * _ / Math.abs(o._rate))), setTimeout(function () {
                        o._emit("play", i._id)
                    }, 0)
                };
                o._loaded ? f() : (o.once("load", f), o._clearTimer(i._id))
            } else {
                var c = function () {
                    l.currentTime = a, l.muted = i._muted || o._muted || u._muted || l.muted, l.volume = i._volume * u.volume(), l.playbackRate = o._rate, setTimeout(function () {
                        l.play(), o._emit("play", i._id)
                    }, 0)
                };
                if (4 === l.readyState || !l.readyState && navigator.isCocoonJS)c(); else {
                    var p = function () {
                        o._endTimers[i._id] = setTimeout(s, 1e3 * _ / Math.abs(o._rate)), c(), l.removeEventListener("canplaythrough", p, !1)
                    };
                    l.addEventListener("canplaythrough", p, !1), o._clearTimer(i._id)
                }
            }
            return i._id
        }, pause: function (e) {
            ...
            for (var r = t._getSoundIds(o), d = 0; d < r.length; d++) {
                var i = t._soundById(r[d]);
                i && (i._muted = e, t._webAudio && i._node ? i._node.gain.setValueAtTime(e ? 0 : i._volume * u.volume(), n.currentTime) : i._node && (i._node.muted = u._muted ? !0 : e))
            }
            return t
        }, volume: function () {
            ...
            if (1 === r.length) {
                var d = t._getSoundIds(), i = d.indexOf(r[0]);
            ...
            for (var _ = 0; _ < o.length; _++)a = t._soundById(o[_]), a && (a._volume = e, t._webAudio && a._node ? a._node.gain.setValueAtTime(e * u.volume(), n.currentTime) : a._node && (a._node.volume = e * u.volume()));
            return t
            ...
            for (var u = d._getSoundIds(r), i = 0; i < u.length; i++) {
                ...
                if (a)if (d._webAudio) {
                    ...
                    a._volume = e, a._node.gain.setValueAtTime(e, _), a._node.gain.linearRampToValueAtTime(o, s), setTimeout(function (e, t) {
                        setTimeout(function () {
            ...
            if (i) {
                if (!(e >= 0))return t._webAudio ? i._seek + (n.currentTime - i._playStart) : i._node.currentTime;
                var a = t.playing(o);
                a && t.pause(o, !0), i._seek = e, t._clearTimer(o), a && t.play(o)
            }
            return t
        }, playing: function (e) {
    ...
    if (a.prototype = {
            init: function () {
                ...
                var e = this, n = e._parent;
                n._duration = Math.ceil(10 * e._node.duration) / 10, 0 === Object.keys(n._sprite).length && (n._sprite = {__default: [0, 1e3 * n._duration]}), n._loaded || (n._loaded = !0, n._emit("load")), n._autoplay && n.play(), e._node.removeEventListener("canplaythrough", e._loadListener, !1)
            }
    ...
    "function" == typeof define && define.amd && define("howler", function () {
        return {Howler: u, Howl: i}
    }), "undefined" != typeof exports && (exports.Howler = u, exports.Howl = i), "undefined" != typeof window && (window.HowlerGlobal = d, window.Howler = u, window.Howl = i, window.Sound = a)
}();
/*! Effects Plugin */
!function () {
    "use strict";
