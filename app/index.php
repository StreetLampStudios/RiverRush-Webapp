<html>
  <head>
	...
	<script>var serverTXTContent;</script>
	<script>serverTXTContent = "<?php if(file_exists('server.txt')) { echo htmlentities(file_get_contents('server.txt')); } else { echo '';} ?>";</script>
